...
const lectures = [
  {
    ...
    termList: [
      ...
      { id: 7, term: "ちゃん", extra: "", answer: "Sufijo antiguamente para niñas pero hoy en dia cualquier sexo" },
      { id: 8, term: "くん", extra: "", answer: "Sufijo antiguamente para niños pero hoy en dia cualquier sexo" },
      { id: 9, term: "じん", extra: "人", answer: "Sufijo nacionalidad" },
      { id: 10, term: "せんせい", extra: "先生", answer: "Profesor(para llamar atencion del profesor)" },
      {
        id: 11,
        term: "きょうし",
        extra: "教師",
      ...
      { id: 12, term: "がくせい", extra: "学生", answer: "Estudiante(cuando te refieres a ti mismo)" },
      { id: 45, term: "せいと", extra: "生徒", answer: "Estudiante(para llamar la atencion del estudiante)" },
      {
        id: 13,
        term: "かいしゃいん",
        extra: "会社員",
      ...
      { id: 29, term: "しつれいですが", extra: "失礼ですが", answer: "Disculpe pero" },
      { id: 30, term: "おなまえは？", extra: "お名前は", answer: "Como se llama usted?" },
      { id: 31, term: "はじめまして", extra: "初めまして", answer: "Mucho gusto" },
      {
        id: 32,
        term: "どうぞよろしく",
        extra: "",
  ...
  },
  {
    ...
    termList: [
      ...
      { id: 29, term: "げんざい", extra: "現在", answer: "Ahora(solo ocupado en escritura)" },
  ...
  },
  {
    ...
    termList: [
      ...
      { id: 29, term: "現在", extra: "", answer: "げんざい / Ahora(solo se usa en escritura)" },
  ...
  },
  {
    ...
    termList: [
      ...
      { id: 3, term: "じょし", extra: "女子", answer: "Mujer, Niña, (hasta 18 años)" },
      { id: 4, term: "だんし", extra: "男子", answer: "Hombre, Niño, (hasta 18 años)" },
      { id: 5, term: "もじ", extra: "文字", answer: "Letra" },
      { id: 6, term: "ぶん", extra: "文", answer: "Oracion" },
      { id: 7, term: "ぶんしょう", extra: "文章", answer: "Ensayo（escrito）, Oraciones" },
  ...
  },
  {
    ...
    termList: [
      ...
      { id: 43, term: "飲む", extra: "", answer: "のみます、のむ / Beber, Tomar" },
  ...
  },
  {
    ...
    termList: [
      ...
      { id: 21, term: "ちょうしょく", extra: "朝食", answer: "Desayuno (formal)" },
      { id: 22, term: "ひる", extra: "昼", answer: "Mediodia" },
      { id: 23, term: "ひるごはん", extra: "昼ごはん", answer: "Almuerzo" },
      { id: 24, term: "ちゅうしょく", extra: "昼食", answer: "Almuerzo (formal)" },
  ...
  },
  {
    ...
    termList: [
      ...
      { id: 21, term: "朝食", extra: "", answer: "ちょうしょく / Desayuno (formal)" },
      { id: 22, term: "昼", extra: "", answer: "ひる / Mediodia" },
      { id: 23, term: "昼ごはん", extra: "", answer: "ひるごはん / Almuerzo" },
      { id: 24, term: "昼食", extra: "", answer: "ちゅうしょく / Almuerzo (formal)" },
