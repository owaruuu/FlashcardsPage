...
function UpdateLocalStorage(lectureObj, tag, id) {
  ...
  console.log(
    "al hacer click en el boton se encontro un objeto en local storage"
  );
...
function ClickKnowledgeButton(event, lectureObj, tag) {
  ...
  let currentTermId = GetTermId(
    lectureObj.termList,
    lectureObj.termList[termIndex].term
  );
